...
public class Transaction{
  ...
  String fundsInvolvedString = transactionFileLine.substring(FUNDS_INVOLVED_START,
									    FUNDS_INVOLVED_END);

  if(fundsInvolvedString.compareTo("        ") == 0)
  {
    this.fundsInvolved = 0;
  }
  else
  {
    this.fundsInvolved = Float.parseFloat(fundsInvolvedString);
  }
